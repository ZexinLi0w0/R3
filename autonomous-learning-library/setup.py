...
setup(
    ...
    install_requires=[
        # R3 modernization: relaxed pins so JetPack 6.2 wheels (PyTorch 2.5.x)
        # and the latest Gymnasium can satisfy the constraints.
        ...
        "torch>=2.0",  # core deep learning library (2.0..2.5+ supported)
